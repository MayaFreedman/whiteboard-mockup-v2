    ...
    <div className="space-y-3">
      ...
      <div className="text-xs text-muted-foreground space-y-1">
        <div className="flex justify-between">
          <span>Custom stamps: {storageInfo.count}/{storageInfo.maxCount}</span>
          <span>
            {Math.round(storageInfo.totalSize / 1024)}KB / {Math.round(storageInfo.maxSize / 1024 / 1024)}MB
          </span>
        </div>
        {storageInfo.usage > 0.8 && (
